...
public class NetworkManager : Photon.PunBehaviour
{
    ...
    void Awake()
    {
        ...
        PhotonHandler.DontDestroyOnLoad(Instance);
    }
    #endregion
    ...
    private void Start()
    {
        ...
        //PhotonNetwork.player.NickName = PlayerPrefs.GetString("username");   Todo: Do this on Lobby setup
    }
    ...
    public bool JoinRandomRoom()
    {
        ...
        {
            if (JoinRoom(publicRooms[UnityEngine.Random.Range(0, publicRooms.Count)].Name))
            {
